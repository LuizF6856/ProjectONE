...
defmodule Formas_geometricas do
    defp triangulo(base, altura), do: "Base = #{base} e Altura = #{altura}, teremos a Area = #{(base * altura)/2}"
    defp quadrado(lado), do: "Com lado = #{lado}, teremos a Area = #{lado * lado}"
    defp retangulo(base, altura), do: "Base = #{base} e Altura = #{altura}, teremos a Area = #{base * altura}"
